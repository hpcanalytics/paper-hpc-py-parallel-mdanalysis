...
When a process tries to access a block of data, request is first decomposed into individual blocks representing the contribution to the total request from the data held locally on each process (\textit{B. J. Palmer and J. Daily, personal communication}).\obnote{This ``personal communication'' reference is broken; e.g. no author. Can you replace it with something fully citable --- a paper or docs? Personal communication citations are not very useful but if you want to keep it, write it in text: (A.U. Thor, personal communication). The journal might still not allow it.} \mknote{I did not find this info from the paper or documentation. I contacted jeff daily he helped me with some parts and for the other parts he introduced B. J. Palmer and I contacted him and had discussion with him and he explained these to me. That is why I said personal communication. They work for pnnl}
