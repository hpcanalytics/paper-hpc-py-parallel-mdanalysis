...
\begin{algorithm}[ht]
	\scriptsize
	\caption{MPI-parallel Multi-frame RMSD Algorithm\gpnote{This is my suggestion. I believe some of the comments are very naive for the BioSim community. Please remove them}}
	\label{alg:RMSD_sug}
...
\begin{algorithm}[ht!]
	...
	\begin{algorithmic}[1]
		...
		\EndProcedure
		\\
		\Procedure{$residues\_to\_dihedrals$}{residues}\gpnote{This is not called anywhere. It should either be removed or connected to the rest of the listing}\mknote{I added it}
		\State List angles
