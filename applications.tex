...
The order of complexity for RMSD algorithm \ref{alg:RMSD} is $T \times N^{2}$ \cite{rmsd} where T is the number of frames in the trajectory and N the number of particles in a frame.
