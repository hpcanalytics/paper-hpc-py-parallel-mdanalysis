...
\emph{Global Arrays in NumPy} (GAiN) extends GA to Python through NumPy \cite{GAiN} and uses \package{mpi4py} (Section \ref{sec:methods-mpi4py}) for its MPI functionality.
