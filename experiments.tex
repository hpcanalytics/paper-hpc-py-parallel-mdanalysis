...
though they still contribute to large variations in timing across different ranks and thus to somewhat erratic scaling.\gpnote{What is erratic scaling? Can you quantify it?}\mknote{It just means that the scaling is not linear and goes up \& down. This is because time distribution is not uniform across different ranks.}\gpnote{I see. May I suggest: "... and thus to fluctuating scaling" or "...and thus irregular scaling as show by its fluctuations"}
...
This means that the task remains communication bound (\mknote{Add same plot as \ref{fig:tcomp_tcomm_ratio_dihed} for comm bound task}). 
