...
Continuously keeping metadata updated in order to have fully consistent reads and writes, requires writing a new value for the file's last-accessed time (POSIX atime) every time a file is read. 
