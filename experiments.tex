...
\caption{Average compute to communication ratio with number of processes for Dihedral featurization task.
...
This task is compute bound and the compute portion is not shown here to show the variation in communication time across different ranks. 
