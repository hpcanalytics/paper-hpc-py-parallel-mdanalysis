...
For 24 MPI ranks (one \emph{SDSC Comet} node), the aggregated reading rate would have been about 1 GB/s, which seemed to be well within the available bandwidth of 56 Gb/s of the Infiniband network interface that served the Lustre file system.
