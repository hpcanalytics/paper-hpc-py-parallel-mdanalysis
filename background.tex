...
The present work is motivated to better understand the requirements for efficient parallel analysis of MD trajectories in order to implement efficient parallel algorithms in \package{MDAnalysis} but to also provide more generally guidance for similar developments in other libraries.
