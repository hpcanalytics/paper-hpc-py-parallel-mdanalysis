...
\gpnote{I do not understand this sentence at all. I do not think it is needed at all here. I suggest to remove it. :
...
\gpnote{ Arguing about open source does not have to do with the problem this paper addresses. I suggest to remove: Furthermore, HiMach is not available under an open source license, which does not allow community contributions and continuous integration with state-of-the-art methods.}
