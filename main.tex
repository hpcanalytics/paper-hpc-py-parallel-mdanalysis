...
\begin{keyword}
Python\sep MPI\sep HPC\sep MDAnalysis\sep Global Array\sep MPI I/O\sep Straggler\sep Molecular Dynamics\sep Big Data\sep Trajectory Analysis
...
\section{Detailed timing for splitting trajectories}
\input{splitting.tex}
