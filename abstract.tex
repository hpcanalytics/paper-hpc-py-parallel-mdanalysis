\begin{abstract} 
\obnote{The code repo https://github.com/hpcanalytics/supplement-hpc-py-parallel-mdanalysis should have the documentation to recreate the computational environment on the tested HPC resources.}
...
We investigated a single program multiple data (SPMD) execution model where each process executes the same program, to parallelize Root Mean Square Distance (RMSD) and Dihedral Featurization algorithms in the MDAnalysis library using the Map-Reduce approach. 
