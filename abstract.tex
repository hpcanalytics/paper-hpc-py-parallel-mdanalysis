...
Straggler tasks are a very common problem in heterogeneous resource environments and are significantly slower ($\approx 6 \times$) than the mean execution time of all tasks, impeding job completion time.
