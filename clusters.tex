...
These cases include: Splitting the trajectories with collective communications in MPI, Splitting the trajectories with Global Arrays for communications, and MPI-based Parallel HDF5.
...
Each process is able to directly access data held in a section of a Global Arrays that is locally assigned to that process \cite{GA}.
...
and results are communicated back to rank 0 (communications included). Five repeats were performed to 
