...
Figure \ref{fig:MPI-splitting-clusters} shows the strong scaling of the RMSD task  with increasing numbers of cores on different HPC resources.  
...
Five repeats were performed to collect statistics and these were typical data from one run of the 5 repeats. Compute \tcomp, I/O \tIO, communication \tcomm, ending the for loop \text{$t_{\text{end\_loop}}$},
...
This performance difference became more obvious with increasing core numbers.
