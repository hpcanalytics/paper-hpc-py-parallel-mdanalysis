...
\obnote{We/I put this hypothesis forward originally but I don?t think that we really have enough evidence to corroborate it. 
We know that we have a problem with multiple ranks accessing the same file but we don?t have this problem with splitting or parallel I/O. 
I think that?s really all we can say right now.}\mknote{I think we have enough evidences, I tried to explain it in a better way. please have a look and let me know if it is still not clear from my reasoning} 
\obnote{Can you look in the literature to see what is known about Lustre and accessing a single file? 
Papers on parallel I/O should discuss this problem.}\mknote{Will have a look}
