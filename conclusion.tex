...
This intepretation suggested we needed to improve read I/O to reduce interference.
...
Somewhat surprisingly, \package{Global Arrays} reduced the communication cost compared to MPI collective communications even though it only acts as programming layer to access data across multiple nodes in a convenient array form and also uses MPI for its inter-node data exchange.
