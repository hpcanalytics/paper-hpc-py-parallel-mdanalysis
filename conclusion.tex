...
\package{Global Arrays} reduced the communication cost compared to MPI collective communications, which was somewhat surprising because it only acts as programming layer to access data across multiple nodes in a convenient array form and just uses MPI for its inter-node data exchange.
