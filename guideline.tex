...
\gpnote{Rule is something that needs to be followed exactly. As a result it requires a theorem and a proof. I suggest instead of rules say heuristic? From Wiki:A heuristic technique, often called simply a heuristic, is any approach to problem solving, learning, or discovery that employs a practical method, not guaranteed to be optimal, perfect, logical, or rational, but instead sufficient for reaching an immediate goal.}
\begin{description}
