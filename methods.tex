...
\obnote{Rewrite so that you define timing variables with respect to line numbers in the code (where t\_Ln means the time for that line included).}
\mknote{I do not agree with this method especially because the line numbers differs for different algorithms but the current way is more general}
