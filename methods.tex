...
The total I/O time for a rank  $\tIO = \sum_{\text{frames}}^{\text{N}_{\text{frames}}} t_{\text{I/O}}^{\text{frame}}$ is the sum over all I/O times for all the $N_{\text{frames}}$ frames assigned to the rank; similarly, the total compute time for a rank is $\tcomp = \sum_{\text{frame}}^{N_{\text{frames}}} t_{\text{comp}}^{\text{frame}}$. 
