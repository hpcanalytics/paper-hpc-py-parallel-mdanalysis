...
\end{equation}
Because \tcomm cannot be measured for a serial code, we estimated \Rcompcomm from the rank-averages Eqs.~\ref{eq:avg-tIO} and \ref{eq:avg-tcomm} for a given number of MPI ranks.
