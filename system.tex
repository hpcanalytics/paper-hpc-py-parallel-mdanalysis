...
We used the \package{h5py} package for HDF5, which, when provided with the HDF5 library itself and \package{mpi4py} both built against Open MPI, enables parallel HDF5 from Python.
