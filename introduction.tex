...
Scaling diagnosing for HPC applications can be extremely difficult due to their complicated behaviors and combination of various parameters that might simultaneously affect scaling performance.
...
Section \ref{sec:methods} explains how our performance model works.
