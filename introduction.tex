...
We investigated the \package{Dask} library \cite{Rocklin:2015aa} and MPI, using the \package{mpi4py} package \cite{Dalcin:2011aa, Dalcin:2005aa}, for parallelization. 
...
In the present study, we analyzed the MPI case in more detail to better understand the origin of the stragglers with the goal to find simple and robust parallelization approaches to speed up parallel post-processing of MD trajectories in the \package{MDAnalysis} library. 
