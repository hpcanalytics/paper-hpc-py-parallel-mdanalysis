...
Here we discuss the challenges and lessons-learned for making parallel analysis on HPC resources feasible for MDAnalysis~\gpnote{ This makes me ask are there not other generel purpose libraries: a general purpose trajectory analysis library}.
...
We investigated \package{Dask}~\cite{Rocklin:2015aa} and MPI, using the \package{mpi4py}~\cite{Dalcin:2011aa, Dalcin:2005aa}, for parallelization. 
