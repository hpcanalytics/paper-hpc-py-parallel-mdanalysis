...
\begin{figure}[!htb]
  ...
  \caption{\emph{LSU SuperMIC}: Comparison of the performance of the RMSD task with subfiling and using either using MPI  (``MPI'') or \package{Global Arrays} (``ga'') for communication.
