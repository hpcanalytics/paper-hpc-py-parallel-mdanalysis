...
\newcommand{\tcomp}{\ensuremath{{t}_{\text{compute\_final}}}\xspace}
\newcommand{\tIO}{\ensuremath{{t}_{\text{I/O\_final}}}\xspace}
...
\newcommand{\rthreenote}[1]{ {\textcolor{cyan} { Reviewer 2: #1 }}}
\definecolor{orange}{rgb}{1,.5,0}
\definecolor{dandelion}{cmyk}{0,0.29,0.84,0}
\newcommand{\mknote}[1]{ {\textcolor{dandelion} { ***mahzad: #1 }}}
\newcommand{\rtwonote}[1]{ {\textcolor{dandelion} { ***Reviewer 2: #1 }}}
\newcommand{\gpnote}[1]{{\textcolor{green} {***giannis: #1}}}
\newcommand{\note}[1]{ {\textcolor{magenta} { ***Note: #1 }}}
\newcommand{\rfournote}[1]{ {\textcolor{orange} { ***Reviewer 4: #1 }}}
\else
